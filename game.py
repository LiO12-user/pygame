...
class Bomb:
    ...
    def detect_collision(self):
        ...
        print(len(self.bomb_x_ar))
        for i in range(self.num_of_bombs):

            if self.bomb_y_ar[i] < Player.player_pos_y and self.bomb_y_ar[i] + 63 > Player.player_pos_y and self.bomb_x_ar[i] < Player.player_pos_x and self.bomb_x_ar[i] + 63 > Player.player_pos_x or Player.player_pos_y + 63 > self.bomb_y_ar[i] and Player.player_pos_y < self.bomb_y_ar[
                        i] + 63 and Player.player_pos_x + 63 > self.bomb_x_ar[i] and Player.player_pos_x < self.bomb_x_ar[i] + 63:
    ...
    def show_bombs(self):
        for i in range(self.num_of_bombs):
            ...
            self.bomb_y_ar[i] += random.randint(1, 6)
